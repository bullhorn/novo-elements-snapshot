...
export declare class NovoTipWellElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTipWellElement, "novo-tip-well", never, { "name": "name"; "tip": "tip"; "buttonText": "buttonText"; "button": "button"; "icon": "icon"; "sanitize": "sanitize"; }, { "confirmed": "confirmed"; }, never, never>;
}
