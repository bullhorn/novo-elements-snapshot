...
export declare class NovoDateFormatDirective extends IMaskDirective<any> {
    ...
    constructor(_element: ElementRef, _renderer: Renderer2, _factory: IMaskFactory, _platformId: string, _compositionMode: boolean, labels: NovoLabelService);
    normalize(value: string): string;
    formatAsIso(date: Date): string;
    formatValue(value: any): string;
    writeValue(value: any): void;
    registerOnChange(fn: (_: any) => void): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoDateFormatDirective, [null, null, null, { optional: true; }, { optional: true; }, null]>;
