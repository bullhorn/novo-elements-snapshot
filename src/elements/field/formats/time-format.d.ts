...
export declare class NovoTimeFormatDirective extends IMaskDirective<any> implements NovoInputFormat, AfterViewInit, OnChanges {
    ...
    constructor(_element: ElementRef, _renderer: Renderer2, _factory: IMaskFactory, _platformId: string, _compositionMode: boolean, labels: NovoLabelService, cdr: ChangeDetectorRef);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoTimeFormatDirective, [null, null, null, { optional: true; }, { optional: true; }, null, null]>;
