...
export declare class StaticDataTableService<T> implements IDataTableService<T> {
    ...
    getTableResults(sort: IDataTableSort, filter: IDataTableFilter | IDataTableFilter[], page: number, pageSize: number, globalSearch?: string, outsideFilter?: any, advancedFilter?: IDataTableFilter[], where?: {
        query: string;
        form: any;
    }): Observable<{
        results: T[];
