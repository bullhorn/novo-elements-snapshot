...
export declare class NovoListItemElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoListItemElement, "novo-list-item, a[list-item], button[list-item]", never, {}, {}, ["_content", "_header"], ["item-header, novo-item-header", "item-content, novo-item-content", "*", "item-end, novo-item-end"]>;
}
