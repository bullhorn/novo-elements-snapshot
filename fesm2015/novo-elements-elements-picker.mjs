...
class NovoPickerElement {
    ...
    ngOnInit() {
        ...
        let debounceTimeInMilliSeconds = Number.isNaN(Number((_a = this.config) === null || _a === void 0 ? void 0 : _a.debounceTimeInMilliSeconds)) ? DEFAULT_DEBOUNCE_TIME : Number((_b = this.config) === null || _b === void 0 ? void 0 : _b.debounceTimeInMilliSeconds);
