...
import { InjectionToken, Component, ChangeDetectionStrategy, Inject, HostBinding, Input, EventEmitter, Injectable, Output, Directive, Optional, ViewChild, HostListener, Pipe, ContentChildren, ViewChildren, NgModule } from '@angular/core';
