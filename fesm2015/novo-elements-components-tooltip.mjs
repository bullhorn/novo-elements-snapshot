...
NovoTooltip.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.11", type: NovoTooltip, selector: "novo-tooltip", ngImport: i0, template: "<div *ngIf=\"this.isHTML\" [@state]=\"noAnimate ? 'no-animation' : 'visible'\"\n     [ngClass]=\"[tooltipType, rounded ? 'rounded' : '', size ? size : '', preline? 'preline' : '', bounce ? 'bounce' : '', position]\"\n     [innerHTML]=\"message\"></div>\n<div *ngIf=\"!this.isHTML\" [@state]=\"noAnimate ? 'no-animation' : 'visible'\"\n     [ngClass]=\"[tooltipType, rounded ? 'rounded' : '', size ? size : '', preline? 'preline' : '', bounce ? 'bounce' : '', position]\">{{message}}</div>", styles: [":host div{color:var(--tooltip-color-text);background-color:var(--tooltip-color-background);box-shadow:var(--tooltip-shadow);border-radius:var(--tooltip-border-radius);border:1px solid var(--tooltip-color-border);padding:var(--spacing-sm) var(--spacing-md);font-size:var(font-size-sm);line-height:var(font-size-sm);white-space:nowrap}:host div.error{background-color:#b34e4d;background-color:var(--color-error, #b34e4d);color:var(--color-error-contrast)}:host div.error.top-right:before,:host div.error.top-left:before,:host div.error.top:before{border-top-color:#b34e4d;border-top-color:var(--color-error, #b34e4d)}:host div.error.bottom-left:before,:host div.error.bottom-right:before,:host div.error.bottom:before{border-bottom-color:#b34e4d;border-bottom-color:var(--color-error, #b34e4d)}:host div.error.left:before{border-left-color:#b34e4d;border-left-color:var(--color-error, #b34e4d)}:host div.error.right:before{border-right-color:#b34e4d;border-right-color:var(--color-error, #b34e4d)}:host div.info{background-color:#3986ac;background-color:var(--color-info, #3986ac);color:var(--color-info-contrast)}:host div.info.top-right:before,:host div.info.top-left:before,:host div.info.top:before{border-top-color:#3986ac;border-top-color:var(--color-info, #3986ac)}:host div.info.bottom-left:before,:host div.info.bottom-right:before,:host div.info.bottom:before{border-bottom-color:#3986ac;border-bottom-color:var(--color-info, #3986ac)}:host div.info.left:before{border-left-color:#3986ac;border-left-color:var(--color-info, #3986ac)}:host div.info.right:before{border-right-color:#3986ac;border-right-color:var(--color-info, #3986ac)}:host div.warning{background-color:#c09854;background-color:var(--color-warning, #c09854);color:var(--color-warning-contrast)}:host div.warning.top-right:before,:host div.warning.top-left:before,:host div.warning.top:before{border-top-color:#c09854;border-top-color:var(--color-warning, #c09854)}:host div.warning.bottom-left:before,:host div.warning.bottom-right:before,:host div.warning.bottom:before{border-bottom-color:#c09854;border-bottom-color:var(--color-warning, #c09854)}:host div.warning.left:before{border-left-color:#c09854;border-left-color:var(--color-warning, #c09854)}:host div.warning.right:before{border-right-color:#c09854;border-right-color:var(--color-warning, #c09854)}:host div.success{background-color:#458746;background-color:var(--color-success, #458746);color:var(--color-success-contrast)}:host div.success.top-right:before,:host div.success.top-left:before,:host div.success.top:before{border-top-color:#458746;border-top-color:var(--color-success, #458746)}:host div.success.bottom-left:before,:host div.success.bottom-right:before,:host div.success.bottom:before{border-bottom-color:#458746;border-bottom-color:var(--color-success, #458746)}:host div.success.left:before{border-left-color:#458746;border-left-color:var(--color-success, #458746)}:host div.success.right:before{border-right-color:#458746;border-right-color:var(--color-success, #458746)}:host div.top-right:before,:host div.top-left:before,:host div.top:before{border-top-color:var(--tooltip-color-background)}:host div.bottom-left:before,:host div.bottom-right:before,:host div.bottom:before{border-bottom-color:var(--tooltip-color-background)}:host div.left:before{border-left-color:var(--tooltip-color-background)}:host div.right:before{border-right-color:var(--tooltip-color-background)}:host div.top:before{margin-bottom:-11px;left:calc(50% - 6px);bottom:0}:host div.top-left:before{margin-right:0;margin-bottom:-11px;right:1px;bottom:0}:host div.top-right:before{margin-left:0;margin-bottom:-11px;left:1px;bottom:0}:host div.bottom:before{margin-top:-11px;left:calc(50% - 6px);top:0}:host div.bottom-left:before{margin-right:0;margin-top:-11px;right:1px;top:0}:host div.bottom-right:before{margin-left:0;margin-top:-11px;left:1px;top:0}:host div.left:before{margin-right:-11px;margin-bottom:-6px;right:0;bottom:50%}:host div.right:before{left:0;bottom:50%;margin-left:-11px;margin-bottom:-6px}:host div:before{content:\"\";position:absolute;background:0 0;border:6px solid transparent;box-sizing:border-box}:host div.extra-large,:host div.large,:host div.small,:host div.medium{white-space:normal;line-height:1.4em;word-wrap:break-word}:host div.extra-large{width:400px;font-size:1.2vh}:host div.large{width:300px}:host div.medium{width:150px}:host div.small{width:80px}:host div.preline{white-space:pre-line}:host div.bounce{-webkit-animation:bounce .75s ease-in-out infinite;animation:bounce .75s ease-in-out infinite}@-webkit-keyframes bounce{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes bounce{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}\n"], directives: [{ type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }], animations: [
        trigger('state', [
...
//# sourceMappingURL=novo-elements-components-tooltip.mjs.map
