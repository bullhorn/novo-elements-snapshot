...
ComponentUtils.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: ComponentUtils, deps: [{ token: i0.ComponentFactoryResolver }], target: i0.ɵɵFactoryTarget.Injectable });
ComponentUtils.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: ComponentUtils });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: ComponentUtils, decorators: [{
            type: Injectable
...
NovoLabelService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: NovoLabelService, deps: [{ token: LOCALE_ID, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
NovoLabelService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: NovoLabelService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: NovoLabelService, decorators: [{
            type: Injectable
...
class DateFormatService {
    ...
    parseTimeString(timeString, militaryTime) {
        ...
        if (!militaryTime && amFormat && pmFormat) {
            ...
            if (splits === null || splits === void 0 ? void 0 : splits.length) {
                for (const item of splits) {
                    if (item === null || item === void 0 ? void 0 : item.trim().includes(':')) {
                        timeStringParts = item.trim().split(':');
                    }
                }
            }
            if ((timeStringParts === null || timeStringParts === void 0 ? void 0 : timeStringParts.length) && timeStringParts.length === 2) {
            ...
            if ((timeStringParts === null || timeStringParts === void 0 ? void 0 : timeStringParts.length) && timeStringParts.length === 3) {
    ...
    parseString(dateTimeString, militaryTime, type) {
        if (!(dateTimeString === null || dateTimeString === void 0 ? void 0 : dateTimeString.length)) {
            return null;
        }
        switch (type) {
            case 'datetime':
...
DateFormatService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: DateFormatService, deps: [{ token: NovoLabelService }], target: i0.ɵɵFactoryTarget.Injectable });
DateFormatService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: DateFormatService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: DateFormatService, decorators: [{
            type: Injectable
...
BrowserGlobalRef.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: BrowserGlobalRef, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
BrowserGlobalRef.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: BrowserGlobalRef });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: BrowserGlobalRef, decorators: [{
            type: Injectable
        }] });
