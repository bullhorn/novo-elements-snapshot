...
import { NovoIconComponent, NovoIconModule } from 'novo-elements/components/icon';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: NovoStep, decorators: [{
        ...
        return [{ type: i1$2.CdkStepper, decorators: [{
                        type: Inject,
...
//# sourceMappingURL=novo-elements-components-stepper.mjs.map
