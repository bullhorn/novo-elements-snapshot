...
class NovoAutocompleteElement extends NovoAutocompleteMixins {
    ...
    _setTriggerValue(option) {
        const toDisplay = this.displayWith ? this.displayWith(option) : option === null || option === void 0 ? void 0 : option.viewValue;
    ...
    _selectValue(value) {
        ...
        correspondingOption === null || correspondingOption === void 0 ? void 0 : correspondingOption.select();
