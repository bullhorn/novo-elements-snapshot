...
import { Component, Input, Directive, EventEmitter, Output, ViewContainerRef, ViewChild, HostListener, NgModule, ElementRef, ViewChildren } from '@angular/core';
