...
import { forwardRef, EventEmitter, HostBinding, HostListener, ViewChild, Output, Input, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
