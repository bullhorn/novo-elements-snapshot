...
import { TemplateRef, isDevMode, EventEmitter, Output, Directive } from '@angular/core';
...
class OutsideClick {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: OutsideClick, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.19", type: OutsideClick, isStandalone: true, outputs: { onOutsideClick: "onOutsideClick", onActiveChange: "onActiveChange" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: OutsideClick, decorators: [{
            type: Directive
        }], ctorParameters: () => [{ type: i0.ElementRef }], propDecorators: { onOutsideClick: [{
                type: Output
            }], onActiveChange: [{
                type: Output
            }] } });
