...
import { InjectionToken, Component, ChangeDetectionStrategy, Inject, HostBinding, Input, EventEmitter, Injectable, Output, Directive, Optional, ViewChild, HostListener, Pipe, viewChild, signal, effect, ViewEncapsulation, ContentChildren, ViewChildren, NgModule } from '@angular/core';
...
import { FixedSizeVirtualScrollStrategy, VIRTUAL_SCROLL_STRATEGY, CdkVirtualScrollViewport, ScrollingModule } from '@angular/cdk/scrolling';
...
class NovoDataTableCellFilterHeader {
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: i6.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: i3$1.NovoButtonElement, selector: "novo-button,button[theme]", inputs: ["color", "side", "size", "theme", "loading", "icon", "secondIcon", "disabled"] }, { kind: "component", type: i11.NovoLabel, selector: "novo-label,[novo-label]" }, { kind: "directive", type: i11.ThemeColorDirective, selector: "[theme]", inputs: ["theme"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
...
class NovoDataTableVirtualScrollStrategy extends FixedSizeVirtualScrollStrategy {
    constructor() {
...
class NovoDataTable {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: NovoDataTable, deps: [{ token: i1$1.NovoLabelService }, { token: i0.ChangeDetectorRef }, { token: DataTableState }, { token: VIRTUAL_SCROLL_STRATEGY }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: NovoDataTable, decorators: [{
  ...
  `, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, providers: [
        ...
        }], ctorParameters: () => [{ type: i1$1.NovoLabelService }, { type: i0.ChangeDetectorRef }, { type: DataTableState }, { type: NovoDataTableVirtualScrollStrategy, decorators: [{
                    type: Inject,
