...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: EntityPickerResult, decorators: [{
  ...
  `, standalone: false, styles: [":host(.disabled){opacity:.5;pointer-events:none}:host(.active)>novo-list-item{background-color:hsl(from var(--color-positive) h s calc(l + 35))}\n"] }]
...
class GroupedMultiPickerResults extends BasePickerResults {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: GroupedMultiPickerResults, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i1.NovoLabelService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.19", type: GroupedMultiPickerResults, isStandalone: false, selector: "grouped-multi-picker-results", viewQueries: [{ propertyName: "inputElement", first: true, predicate: ["input"], descendants: true, static: true }, { propertyName: "listElement", first: true, predicate: ["list"], descendants: true }], usesInheritance: true, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: GroupedMultiPickerResults, decorators: [{
  ...
  `, standalone: false, styles: [":host{background-color:var(--background-body);max-height:300px;padding:0;margin:0;box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f;border:1px solid var(--color-positive);transform:translateY(0);transition:all .15s cubic-bezier(.35,0,.25,1);display:flex;flex-direction:row;width:fit-content}:host novo-list-item{cursor:pointer;flex-shrink:0}:host novo-list-item.disabled{pointer-events:none;opacity:.75}:host novo-list-item ::ng-deep div.list-item{flex:1!important}:host>.grouped-multi-picker-groups{flex:1;display:flex;flex-direction:column}:host>.grouped-multi-picker-groups novo-list{overflow:auto}:host>.grouped-multi-picker-groups footer{flex-basis:50px;min-height:50px;height:50px;display:flex;align-items:center;border-top:1px solid var(--border-2)}:host>.grouped-multi-picker-groups footer label{font-weight:500}:host>.grouped-multi-picker-groups footer.disabled{pointer-events:none;opacity:.75}:host>.grouped-multi-picker-groups novo-list-item{font-weight:500;color:#999;border-left:3px solid #fff}:host>.grouped-multi-picker-groups novo-list-item ::ng-deep .list-item{justify-content:center}:host>.grouped-multi-picker-groups novo-list-item item-end{color:#999}:host>.grouped-multi-picker-groups novo-list-item.active{color:var(--color-positive);border-left-color:var(--color-positive);background-color:#e9e9e9}:host>.grouped-multi-picker-groups novo-list-item.active item-end{color:var(--color-positive)}:host>.grouped-multi-picker-groups novo-list-item.active ::ng-deep .list-item>item-content>*{color:var(--color-positive)!important}:host>.grouped-multi-picker-matches{flex:1;display:flex;flex-direction:column}:host>.grouped-multi-picker-matches novo-list{overflow:auto}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container{position:relative}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container input{font-size:1em;padding:.95em;background:transparent!important;border:none;border-bottom:1px solid var(--border-2);border-left:1px solid var(--border-2);border-radius:0;outline:none;width:100%;margin:0;box-shadow:none;transition:all .3s;color:#26282b}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container input:hover{border-bottom:1px solid var(--border-2)}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container input:focus{border-bottom:1px solid var(--color-positive);border-left:1px solid var(--color-positive)}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container input[disabled]{pointer-events:none;opacity:.4}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container i.bhi-search,:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container i.bhi-times{position:absolute;right:10px;top:12px;font-size:var(--font-size-sm)}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container i.bhi-search.disabled,:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container i.bhi-times.disabled{pointer-events:none;opacity:.4}:host>.grouped-multi-picker-matches .grouped-multi-picker-input-container i.bhi-times{cursor:pointer}:host>.grouped-multi-picker-matches .grouped-multi-picker-list-container{border-left:1px solid var(--border-2);flex:1;display:flex;flex-direction:column;overflow:auto}:host>.grouped-multi-picker-matches .grouped-multi-picker-no-category,:host>.grouped-multi-picker-matches .grouped-multi-picker-no-results,:host>.grouped-multi-picker-matches .grouped-multi-picker-loading{flex:1;justify-content:center;align-items:center;display:flex;text-align:center}\n"] }]
...
class MixedMultiPickerResults extends BasePickerResults {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: MixedMultiPickerResults, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i1.NovoLabelService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.19", type: MixedMultiPickerResults, isStandalone: false, selector: "mixed-multi-picker-results", viewQueries: [{ propertyName: "inputElement", first: true, predicate: ["input"], descendants: true, static: true }, { propertyName: "listElement", first: true, predicate: ["list"], descendants: true }], usesInheritance: true, ngImport: i0, template: ` <div class="mixed-multi-picker-groups">
      <novo-list direction="vertical">
        <novo-list-item
    ...
    </div>`, isInline: true, styles: [":host{background-color:var(--background-body);max-height:300px;padding:0;margin:0;box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f;border:1px solid var(--color-positive);transform:translateY(0);transition:all .15s cubic-bezier(.35,0,.25,1);display:flex;flex-direction:row}:host novo-list-item{cursor:pointer;flex-shrink:0}:host novo-list-item.disabled{pointer-events:none;opacity:.75}:host>.mixed-multi-picker-groups{flex:1;display:flex;flex-direction:column}:host>.mixed-multi-picker-groups novo-list{overflow:auto}:host>.mixed-multi-picker-groups novo-list-item{color:#999;border-left:3px solid #fff;transition:background-color .25s}:host>.mixed-multi-picker-groups novo-list-item>div{width:100%}:host>.mixed-multi-picker-groups novo-list-item:hover{background-color:hsl(from var(--color-positive) h s calc(l + 39))}:host>.mixed-multi-picker-groups novo-list-item .list-item{justify-content:center}:host>.mixed-multi-picker-groups novo-list-item item-end{color:#999}:host>.mixed-multi-picker-groups novo-list-item.active{color:var(--color-positive);border-left-color:var(--color-positive);background-color:hsl(from var(--color-positive) h s calc(l + 35))}:host>.mixed-multi-picker-groups novo-list-item.active item-end{color:var(--color-positive)}:host>.mixed-multi-picker-groups novo-list-item.active .list-item>item-content>*{color:var(--color-positive)!important}:host>.mixed-multi-picker-groups novo-list-item item-content{flex-flow:row wrap}:host>.mixed-multi-picker-groups novo-list-item item-content>*{flex:0 0 33%;white-space:nowrap}:host>.mixed-multi-picker-matches{flex:1;display:flex;flex-direction:column}:host>.mixed-multi-picker-matches novo-list{overflow:auto}:host>.mixed-multi-picker-matches novo-list novo-list-item{cursor:pointer;flex:0 0;transition:background-color .25s}:host>.mixed-multi-picker-matches novo-list novo-list-item>div{width:100%}:host>.mixed-multi-picker-matches novo-list novo-list-item.active{background-color:hsl(from var(--color-positive) h s calc(l + 35))}:host>.mixed-multi-picker-matches novo-list novo-list-item:hover{background-color:hsl(from var(--color-positive) h s calc(l + 39))}:host>.mixed-multi-picker-matches novo-list novo-list-item item-content{flex-flow:row wrap}:host>.mixed-multi-picker-matches novo-list novo-list-item item-content>*{flex:0 0 33%;white-space:nowrap}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container{position:relative}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input{font-size:1em;padding:.95em;background:transparent!important;border:none;border-bottom:1px solid var(--border-2);border-left:1px solid var(--border-2);border-radius:0;outline:none;width:100%;margin:0;box-shadow:none;transition:all .3s;color:#26282b}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input:hover{border-bottom:1px solid var(--border-2)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input:focus{border-bottom:1px solid var(--color-positive);border-left:1px solid var(--color-positive)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input[disabled]{pointer-events:none;opacity:.4}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-search,:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times{position:absolute;right:10px;top:12px;font-size:var(--font-size-sm)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-search.disabled,:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times.disabled{pointer-events:none;opacity:.4}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times{cursor:pointer}:host>.mixed-multi-picker-matches .mixed-multi-picker-list-container{border-left:1px solid var(--border-2);flex:1;display:flex;flex-direction:column;overflow:auto}:host>.mixed-multi-picker-matches .mixed-multi-picker-no-primary,:host>.mixed-multi-picker-matches .mixed-multi-picker-no-results,:host>.mixed-multi-picker-matches .mixed-multi-picker-loading{flex:1;justify-content:center;align-items:center;display:flex;text-align:center}\n"], dependencies: [{ kind: "directive", type: i2.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i3$1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i3$1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i3$1.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "directive", type: i3.ThemeColorDirective, selector: "[theme]", inputs: ["theme"] }, { kind: "component", type: i5.NovoLoadingElement, selector: "novo-loading", inputs: ["theme", "color", "size"] }, { kind: "component", type: i6.NovoListElement, selector: "novo-list", inputs: ["theme", "direction"] }, { kind: "component", type: i6.NovoListItemElement, selector: "novo-list-item, a[list-item], button[list-item]" }, { kind: "component", type: i6.NovoItemContentElement, selector: "item-content, novo-item-content", inputs: ["direction"] }, { kind: "component", type: i6.NovoItemEndElement, selector: "item-end, novo-item-end" }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: MixedMultiPickerResults, decorators: [{
            type: Component,
    ...
    </div>`, standalone: false, styles: [":host{background-color:var(--background-body);max-height:300px;padding:0;margin:0;box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f;border:1px solid var(--color-positive);transform:translateY(0);transition:all .15s cubic-bezier(.35,0,.25,1);display:flex;flex-direction:row}:host novo-list-item{cursor:pointer;flex-shrink:0}:host novo-list-item.disabled{pointer-events:none;opacity:.75}:host>.mixed-multi-picker-groups{flex:1;display:flex;flex-direction:column}:host>.mixed-multi-picker-groups novo-list{overflow:auto}:host>.mixed-multi-picker-groups novo-list-item{color:#999;border-left:3px solid #fff;transition:background-color .25s}:host>.mixed-multi-picker-groups novo-list-item>div{width:100%}:host>.mixed-multi-picker-groups novo-list-item:hover{background-color:hsl(from var(--color-positive) h s calc(l + 39))}:host>.mixed-multi-picker-groups novo-list-item .list-item{justify-content:center}:host>.mixed-multi-picker-groups novo-list-item item-end{color:#999}:host>.mixed-multi-picker-groups novo-list-item.active{color:var(--color-positive);border-left-color:var(--color-positive);background-color:hsl(from var(--color-positive) h s calc(l + 35))}:host>.mixed-multi-picker-groups novo-list-item.active item-end{color:var(--color-positive)}:host>.mixed-multi-picker-groups novo-list-item.active .list-item>item-content>*{color:var(--color-positive)!important}:host>.mixed-multi-picker-groups novo-list-item item-content{flex-flow:row wrap}:host>.mixed-multi-picker-groups novo-list-item item-content>*{flex:0 0 33%;white-space:nowrap}:host>.mixed-multi-picker-matches{flex:1;display:flex;flex-direction:column}:host>.mixed-multi-picker-matches novo-list{overflow:auto}:host>.mixed-multi-picker-matches novo-list novo-list-item{cursor:pointer;flex:0 0;transition:background-color .25s}:host>.mixed-multi-picker-matches novo-list novo-list-item>div{width:100%}:host>.mixed-multi-picker-matches novo-list novo-list-item.active{background-color:hsl(from var(--color-positive) h s calc(l + 35))}:host>.mixed-multi-picker-matches novo-list novo-list-item:hover{background-color:hsl(from var(--color-positive) h s calc(l + 39))}:host>.mixed-multi-picker-matches novo-list novo-list-item item-content{flex-flow:row wrap}:host>.mixed-multi-picker-matches novo-list novo-list-item item-content>*{flex:0 0 33%;white-space:nowrap}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container{position:relative}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input{font-size:1em;padding:.95em;background:transparent!important;border:none;border-bottom:1px solid var(--border-2);border-left:1px solid var(--border-2);border-radius:0;outline:none;width:100%;margin:0;box-shadow:none;transition:all .3s;color:#26282b}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input:hover{border-bottom:1px solid var(--border-2)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input:focus{border-bottom:1px solid var(--color-positive);border-left:1px solid var(--color-positive)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container input[disabled]{pointer-events:none;opacity:.4}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-search,:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times{position:absolute;right:10px;top:12px;font-size:var(--font-size-sm)}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-search.disabled,:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times.disabled{pointer-events:none;opacity:.4}:host>.mixed-multi-picker-matches .mixed-multi-picker-input-container i.bhi-times{cursor:pointer}:host>.mixed-multi-picker-matches .mixed-multi-picker-list-container{border-left:1px solid var(--border-2);flex:1;display:flex;flex-direction:column;overflow:auto}:host>.mixed-multi-picker-matches .mixed-multi-picker-no-primary,:host>.mixed-multi-picker-matches .mixed-multi-picker-no-results,:host>.mixed-multi-picker-matches .mixed-multi-picker-loading{flex:1;justify-content:center;align-items:center;display:flex;text-align:center}\n"] }]
        }], ctorParameters: () => [{ type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i1.NovoLabelService }, { type: i0.ChangeDetectorRef }], propDecorators: { inputElement: [{
                type: ViewChild,
                args: ['input', { static: true }]
            }], listElement: [{
...
class PickerResults extends BasePickerResults {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: PickerResults, deps: [{ token: i0.ElementRef }, { token: i1.NovoLabelService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.19", type: PickerResults, isStandalone: false, selector: "picker-results", host: { classAttribute: "active" }, usesInheritance: true, ngImport: i0, template: `
    <novo-list *ngIf="matches.length > 0" direction="vertical">
      <novo-list-item
        *ngFor="let match of matches"
        (click)="selectMatch($event)"
...
class SkillsSpecialtyPickerResults extends BasePickerResults {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: SkillsSpecialtyPickerResults, deps: [{ token: i0.ElementRef }, { token: i1.NovoLabelService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.19", type: SkillsSpecialtyPickerResults, isStandalone: false, selector: "skill-specialty-picker-results", host: { properties: { "class.active": "this.active" } }, usesInheritance: true, ngImport: i0, template: `
  ...
  `, isInline: true, styles: [":host{display:block;width:100%;color:#000;max-width:none;z-index:99;background:#fff}:host.active{border:1px solid var(--color-positive)}:host novo-list{list-style:none;padding:0;margin:0;max-height:330px;overflow-y:auto;overflow-x:hidden}:host novo-list novo-list-item{cursor:pointer;padding:10px 16px;box-sizing:border-box;display:block}:host novo-list novo-list-item item-content{flex-direction:column}:host novo-list novo-list-item item-content h6{padding-top:0}:host novo-list novo-list-item div{color:gray}:host novo-list novo-list-item span{display:inline-block;min-width:100px;margin:2px 0}:host novo-list novo-list-item.active,:host novo-list novo-list-item:focus,:host novo-list novo-list-item:hover{background-color:hsl(from var(--color-positive) h s calc(l + 35))}:host novo-list novo-list-item.disabled{opacity:.5;pointer-events:none}:host novo-list novo-loading{justify-content:center}:host section{box-shadow:.1em .1em 1em #00000040;z-index:9;position:absolute;width:100%;background-color:#fff;color:#000}:host .picker-error,:host .picker-loading,:host .picker-null{text-align:center;color:hsl(from var(--color-light) h s calc(l - 15))}\n"], dependencies: [{ kind: "directive", type: i2.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i3.ThemeColorDirective, selector: "[theme]", inputs: ["theme"] }, { kind: "component", type: i5.NovoLoadingElement, selector: "novo-loading", inputs: ["theme", "color", "size"] }, { kind: "component", type: i6.NovoListElement, selector: "novo-list", inputs: ["theme", "direction"] }, { kind: "component", type: i6.NovoListItemElement, selector: "novo-list-item, a[list-item], button[list-item]" }, { kind: "component", type: i6.NovoItemContentElement, selector: "item-content, novo-item-content", inputs: ["direction"] }, { kind: "pipe", type: i6$1.HighlightPipe, name: "highlight" }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: SkillsSpecialtyPickerResults, decorators: [{
            type: Component,
...
class WorkersCompCodesPickerResults extends PickerResults {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: WorkersCompCodesPickerResults, deps: [{ token: i0.ElementRef }, { token: i1$1.DomSanitizer }, { token: i1.NovoLabelService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.19", type: WorkersCompCodesPickerResults, isStandalone: false, selector: "workers-comp-codes-picker-results", host: { classAttribute: "active" }, usesInheritance: true, ngImport: i0, template: `
    <section class="picker-loading" *ngIf="isLoading && !matches?.length">
      <novo-loading theme="line"></novo-loading>
    </section>
    <novo-list direction="vertical" *ngIf="matches?.length > 0 && !hasError">
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: WorkersCompCodesPickerResults, decorators: [{
            type: Component,
            args: [{
...
class NovoPickerElement {
  ...
  `, isInline: true, styles: ["novo-picker{width:100%;display:flex;align-items:center;flex-wrap:wrap;justify-content:flex-start;padding-bottom:0;transition:all .2s ease-in-out;position:relative}novo-picker.selected+i,novo-picker.selected:hover+i{color:var(--color-positive)}novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input,novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input:hover,novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input:focus{border-bottom-color:transparent!important}novo-picker input{font-size:1em;background:transparent!important;border:none;border-bottom:1px solid hsl(from var(--color-dark) h s calc(l + 45));border-radius:0;outline:none;height:2rem;width:100%;margin:0;padding:0;box-shadow:none;box-sizing:content-box;transition:all .3s;color:#26282b}novo-picker input:hover{border-bottom:1px solid hsl(from var(--color-dark) h s calc(l + 15))}novo-picker input:focus{border-bottom:1px solid var(--color-positive)}novo-picker input:invalid{border-bottom:1px solid #da4453}novo-picker input.entity-picker{padding-left:2em}novo-picker input.entity-selected{padding-left:2.5em;background:var(--background-main)!important}novo-picker input:disabled{border-bottom:1px dashed hsl(from var(--color-dark) h s calc(l + 45))!important}novo-picker i.bhi-more{position:absolute;left:0;top:2px;background:var(--background-main);font-size:1em;border-radius:var(--border-radius-sm, 3px);padding:3px}novo-picker i.entity-icon{position:absolute;left:5px;top:3px;font-size:1em;border-radius:var(--border-radius-sm, 3px);padding:3px;color:#fff}novo-picker i.entity-icon.black{background:var(--color-black)}novo-picker i.entity-icon.white{background:var(--color-white)}novo-picker i.entity-icon.gray{background:var(--color-gray)}novo-picker i.entity-icon.grey{background:var(--color-grey)}novo-picker i.entity-icon.offWhite{background:var(--color-off-white)}novo-picker i.entity-icon.bright{background:var(--color-bright)}novo-picker i.entity-icon.light{background:var(--color-light)}novo-picker i.entity-icon.neutral{background:var(--color-neutral)}novo-picker i.entity-icon.dark{background:var(--color-dark)}novo-picker i.entity-icon.orange{background:var(--color-orange)}novo-picker i.entity-icon.navigation{background:var(--color-navigation)}novo-picker i.entity-icon.skyBlue{background:var(--color-sky-blue)}novo-picker i.entity-icon.steel{background:var(--color-steel)}novo-picker i.entity-icon.metal{background:var(--color-metal)}novo-picker i.entity-icon.sand{background:var(--color-sand)}novo-picker i.entity-icon.silver{background:var(--color-silver)}novo-picker i.entity-icon.stone{background:var(--color-stone)}novo-picker i.entity-icon.ash{background:var(--color-ash)}novo-picker i.entity-icon.anonymous{background:var(--color-anonymous)}novo-picker i.entity-icon.slate{background:var(--color-slate)}novo-picker i.entity-icon.onyx{background:var(--color-onyx)}novo-picker i.entity-icon.charcoal{background:var(--color-charcoal)}novo-picker i.entity-icon.moonlight{background:var(--color-moonlight)}novo-picker i.entity-icon.midnight{background:var(--color-midnight)}novo-picker i.entity-icon.darkness{background:var(--color-darkness)}novo-picker i.entity-icon.navy{background:var(--color-navy)}novo-picker i.entity-icon.aqua{background:var(--color-aqua)}novo-picker i.entity-icon.ocean{background:var(--color-ocean)}novo-picker i.entity-icon.mint{background:var(--color-mint)}novo-picker i.entity-icon.grass{background:var(--color-grass)}novo-picker i.entity-icon.sunflower{background:var(--color-sunflower)}novo-picker i.entity-icon.bittersweet{background:var(--color-bittersweet)}novo-picker i.entity-icon.grapefruit{background:var(--color-grapefruit)}novo-picker i.entity-icon.carnation{background:var(--color-carnation)}novo-picker i.entity-icon.lavender{background:var(--color-lavender)}novo-picker i.entity-icon.mountain{background:var(--color-mountain)}novo-picker i.entity-icon.info{background:var(--color-info)}novo-picker i.entity-icon.positive{background:var(--color-positive)}novo-picker i.entity-icon.success{background:var(--color-success)}novo-picker i.entity-icon.negative{background:var(--color-negative)}novo-picker i.entity-icon.danger{background:var(--color-danger)}novo-picker i.entity-icon.error{background:var(--color-error)}novo-picker i.entity-icon.warning{background:var(--color-warning)}novo-picker i.entity-icon.empty{background:var(--color-empty)}novo-picker i.entity-icon.disabled{background:var(--color-disabled)}novo-picker i.entity-icon.background{background:var(--color-background)}novo-picker i.entity-icon.backgroundDark{background:var(--color-background-dark)}novo-picker i.entity-icon.border{background:var(--color-border)}novo-picker i.entity-icon.border2{background:var(--color-border2)}novo-picker i.entity-icon.text{background:var(--color-text)}novo-picker i.entity-icon.presentation{background:var(--color-presentation)}novo-picker i.entity-icon.bullhorn{background:var(--color-bullhorn)}novo-picker i.entity-icon.pulse{background:var(--color-pulse)}novo-picker i.entity-icon.fastFind{background:var(--color-fast-find)}novo-picker i.entity-icon.toast{background:var(--color-toast)}novo-picker i.entity-icon.company{background:var(--color-company)}novo-picker i.entity-icon.candidate{background:var(--color-candidate)}novo-picker i.entity-icon.lead{background:var(--color-lead)}novo-picker i.entity-icon.contact{background:var(--color-contact)}novo-picker i.entity-icon.clientcontact{background:var(--color-clientcontact)}novo-picker i.entity-icon.opportunity{background:var(--color-opportunity)}novo-picker i.entity-icon.job{background:var(--color-job)}novo-picker i.entity-icon.joborder{background:var(--color-joborder)}novo-picker i.entity-icon.submission{background:var(--color-submission)}novo-picker i.entity-icon.sendout{background:var(--color-sendout)}novo-picker i.entity-icon.placement{background:var(--color-placement)}novo-picker i.entity-icon.note{background:var(--color-note)}novo-picker i.entity-icon.contract{background:var(--color-contract)}novo-picker i.entity-icon.task{background:var(--color-task)}novo-picker i.entity-icon.jobCode{background:var(--color-job-code)}novo-picker i.entity-icon.earnCode{background:var(--color-earn-code)}novo-picker i.entity-icon.invoiceStatement{background:var(--color-invoice-statement)}novo-picker i.entity-icon.billableCharge{background:var(--color-billable-charge)}novo-picker i.entity-icon.payableCharge{background:var(--color-payable-charge)}novo-picker i.entity-icon.user{background:var(--color-user)}novo-picker i.entity-icon.corporateUser{background:var(--color-corporate-user)}novo-picker i.entity-icon.distributionList{background:var(--color-distribution-list)}novo-picker i.entity-icon.credential{background:var(--color-credential)}novo-picker i.entity-icon.person{background:var(--color-person)}novo-picker i.bhi-search,novo-picker i.bhi-times{position:absolute;right:0;color:var(--font-color-base)}novo-picker i.bhi-search.entity-selected,novo-picker i.bhi-times.entity-selected{right:5px}novo-picker i.bhi-search{top:0;font-size:var(--font-size-sm)}novo-picker i.bhi-times{top:0;cursor:pointer;font-size:var(--font-size-sm)}[data-theme=bh2026] novo-picker i{top:-1px;font-size:var(--typography-body-lg-font-size);line-height:normal}\n"], dependencies: [{ kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i3$1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i3$1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i3$1.MaxLengthValidator, selector: "[maxlength][formControlName],[maxlength][formControl],[maxlength][ngModel]", inputs: ["maxlength"] }, { kind: "directive", type: i3$1.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "component", type: i3.NovoOverlayTemplateComponent, selector: "novo-overlay-template", inputs: ["position", "scrollStrategy", "width", "minWidth", "height", "closeOnSelect", "hasBackdrop", "parent"], outputs: ["select", "opening", "closing", "backDropClicked"] }], encapsulation: i0.ViewEncapsulation.None }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoPickerElement, decorators: [{
            type: Component,
  ...
  `, encapsulation: ViewEncapsulation.None, standalone: false, styles: ["novo-picker{width:100%;display:flex;align-items:center;flex-wrap:wrap;justify-content:flex-start;padding-bottom:0;transition:all .2s ease-in-out;position:relative}novo-picker.selected+i,novo-picker.selected:hover+i{color:var(--color-positive)}novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input,novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input:hover,novo-picker.ng-touched.ng-invalid:not(.ng-pristine)>input:focus{border-bottom-color:transparent!important}novo-picker input{font-size:1em;background:transparent!important;border:none;border-bottom:1px solid hsl(from var(--color-dark) h s calc(l + 45));border-radius:0;outline:none;height:2rem;width:100%;margin:0;padding:0;box-shadow:none;box-sizing:content-box;transition:all .3s;color:#26282b}novo-picker input:hover{border-bottom:1px solid hsl(from var(--color-dark) h s calc(l + 15))}novo-picker input:focus{border-bottom:1px solid var(--color-positive)}novo-picker input:invalid{border-bottom:1px solid #da4453}novo-picker input.entity-picker{padding-left:2em}novo-picker input.entity-selected{padding-left:2.5em;background:var(--background-main)!important}novo-picker input:disabled{border-bottom:1px dashed hsl(from var(--color-dark) h s calc(l + 45))!important}novo-picker i.bhi-more{position:absolute;left:0;top:2px;background:var(--background-main);font-size:1em;border-radius:var(--border-radius-sm, 3px);padding:3px}novo-picker i.entity-icon{position:absolute;left:5px;top:3px;font-size:1em;border-radius:var(--border-radius-sm, 3px);padding:3px;color:#fff}novo-picker i.entity-icon.black{background:var(--color-black)}novo-picker i.entity-icon.white{background:var(--color-white)}novo-picker i.entity-icon.gray{background:var(--color-gray)}novo-picker i.entity-icon.grey{background:var(--color-grey)}novo-picker i.entity-icon.offWhite{background:var(--color-off-white)}novo-picker i.entity-icon.bright{background:var(--color-bright)}novo-picker i.entity-icon.light{background:var(--color-light)}novo-picker i.entity-icon.neutral{background:var(--color-neutral)}novo-picker i.entity-icon.dark{background:var(--color-dark)}novo-picker i.entity-icon.orange{background:var(--color-orange)}novo-picker i.entity-icon.navigation{background:var(--color-navigation)}novo-picker i.entity-icon.skyBlue{background:var(--color-sky-blue)}novo-picker i.entity-icon.steel{background:var(--color-steel)}novo-picker i.entity-icon.metal{background:var(--color-metal)}novo-picker i.entity-icon.sand{background:var(--color-sand)}novo-picker i.entity-icon.silver{background:var(--color-silver)}novo-picker i.entity-icon.stone{background:var(--color-stone)}novo-picker i.entity-icon.ash{background:var(--color-ash)}novo-picker i.entity-icon.anonymous{background:var(--color-anonymous)}novo-picker i.entity-icon.slate{background:var(--color-slate)}novo-picker i.entity-icon.onyx{background:var(--color-onyx)}novo-picker i.entity-icon.charcoal{background:var(--color-charcoal)}novo-picker i.entity-icon.moonlight{background:var(--color-moonlight)}novo-picker i.entity-icon.midnight{background:var(--color-midnight)}novo-picker i.entity-icon.darkness{background:var(--color-darkness)}novo-picker i.entity-icon.navy{background:var(--color-navy)}novo-picker i.entity-icon.aqua{background:var(--color-aqua)}novo-picker i.entity-icon.ocean{background:var(--color-ocean)}novo-picker i.entity-icon.mint{background:var(--color-mint)}novo-picker i.entity-icon.grass{background:var(--color-grass)}novo-picker i.entity-icon.sunflower{background:var(--color-sunflower)}novo-picker i.entity-icon.bittersweet{background:var(--color-bittersweet)}novo-picker i.entity-icon.grapefruit{background:var(--color-grapefruit)}novo-picker i.entity-icon.carnation{background:var(--color-carnation)}novo-picker i.entity-icon.lavender{background:var(--color-lavender)}novo-picker i.entity-icon.mountain{background:var(--color-mountain)}novo-picker i.entity-icon.info{background:var(--color-info)}novo-picker i.entity-icon.positive{background:var(--color-positive)}novo-picker i.entity-icon.success{background:var(--color-success)}novo-picker i.entity-icon.negative{background:var(--color-negative)}novo-picker i.entity-icon.danger{background:var(--color-danger)}novo-picker i.entity-icon.error{background:var(--color-error)}novo-picker i.entity-icon.warning{background:var(--color-warning)}novo-picker i.entity-icon.empty{background:var(--color-empty)}novo-picker i.entity-icon.disabled{background:var(--color-disabled)}novo-picker i.entity-icon.background{background:var(--color-background)}novo-picker i.entity-icon.backgroundDark{background:var(--color-background-dark)}novo-picker i.entity-icon.border{background:var(--color-border)}novo-picker i.entity-icon.border2{background:var(--color-border2)}novo-picker i.entity-icon.text{background:var(--color-text)}novo-picker i.entity-icon.presentation{background:var(--color-presentation)}novo-picker i.entity-icon.bullhorn{background:var(--color-bullhorn)}novo-picker i.entity-icon.pulse{background:var(--color-pulse)}novo-picker i.entity-icon.fastFind{background:var(--color-fast-find)}novo-picker i.entity-icon.toast{background:var(--color-toast)}novo-picker i.entity-icon.company{background:var(--color-company)}novo-picker i.entity-icon.candidate{background:var(--color-candidate)}novo-picker i.entity-icon.lead{background:var(--color-lead)}novo-picker i.entity-icon.contact{background:var(--color-contact)}novo-picker i.entity-icon.clientcontact{background:var(--color-clientcontact)}novo-picker i.entity-icon.opportunity{background:var(--color-opportunity)}novo-picker i.entity-icon.job{background:var(--color-job)}novo-picker i.entity-icon.joborder{background:var(--color-joborder)}novo-picker i.entity-icon.submission{background:var(--color-submission)}novo-picker i.entity-icon.sendout{background:var(--color-sendout)}novo-picker i.entity-icon.placement{background:var(--color-placement)}novo-picker i.entity-icon.note{background:var(--color-note)}novo-picker i.entity-icon.contract{background:var(--color-contract)}novo-picker i.entity-icon.task{background:var(--color-task)}novo-picker i.entity-icon.jobCode{background:var(--color-job-code)}novo-picker i.entity-icon.earnCode{background:var(--color-earn-code)}novo-picker i.entity-icon.invoiceStatement{background:var(--color-invoice-statement)}novo-picker i.entity-icon.billableCharge{background:var(--color-billable-charge)}novo-picker i.entity-icon.payableCharge{background:var(--color-payable-charge)}novo-picker i.entity-icon.user{background:var(--color-user)}novo-picker i.entity-icon.corporateUser{background:var(--color-corporate-user)}novo-picker i.entity-icon.distributionList{background:var(--color-distribution-list)}novo-picker i.entity-icon.credential{background:var(--color-credential)}novo-picker i.entity-icon.person{background:var(--color-person)}novo-picker i.bhi-search,novo-picker i.bhi-times{position:absolute;right:0;color:var(--font-color-base)}novo-picker i.bhi-search.entity-selected,novo-picker i.bhi-times.entity-selected{right:5px}novo-picker i.bhi-search{top:0;font-size:var(--font-size-sm)}novo-picker i.bhi-times{top:0;cursor:pointer;font-size:var(--font-size-sm)}[data-theme=bh2026] novo-picker i{top:-1px;font-size:var(--typography-body-lg-font-size);line-height:normal}\n"] }]
...
class NovoPickerModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoPickerModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.19", ngImport: i0, type: NovoPickerModule, declarations: [NovoPickerElement,
            PickerResults,
            EntityPickerResult,
            EntityPickerResults,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoPickerModule, imports: [CommonModule, NovoPipesModule, FormsModule, NovoCommonModule, NovoLoadingModule, NovoListModule, NovoOverlayModule, NovoSwitchModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoPickerModule, decorators: [{
            type: NgModule,
            args: [{
