...
class NovoChipList extends _NovoChipListMixinBase {
    ...
    _keydown(event) {
        ...
        if (event.key === "Backspace" /* Key.Backspace */ && this._isInputEmpty(target)) {
            ...
            if (event.key === "ArrowRight" /* Key.ArrowRight */ && isLastChip && !isRtl) {
                this._focusInput();
                event.preventDefault();
                return;
            }
            // In RTL: Left arrow on last chip goes to input
            if (event.key === "ArrowLeft" /* Key.ArrowLeft */ && isLastChip && isRtl) {
                this._focusInput();
                event.preventDefault();
                return;
            }
...
class NovoChipInput {
    ...
    constructor(_elementRef, _defaultOptions, _field, _chipList, ngControl, _dir) {
        this._elementRef = _elementRef;
    ...
    _keydown(event) {
        ...
        if (event.key === "ArrowLeft" /* Key.ArrowLeft */ && this._isInputEmpty() && this._isCaretAtStart()) {
