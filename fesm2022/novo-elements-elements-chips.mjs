...
import * as i5$1 from 'novo-elements/elements/icon';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: NovoChipInput, decorators: [{
            ...
            args: [{
                ...
                }] }, { type: i5.NovoFieldElement, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
