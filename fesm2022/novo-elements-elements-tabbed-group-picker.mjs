...
class NovoTabbedGroupPickerElement {
    constructor(labelService, ref) {
        ...
        this.useChips = input(false);
        this.maxChips = input(3);
        this.chipSize = input('md');
        ...
        this.selectedChips = signal([]);
        this.showAllChips = signal(false);
        this.displayedChips = computed(() => this.showAllChips() ? this.selectedChips() : this.selectedChips().slice(0, this.maxChips()));
        this.hiddenChips = computed(() => this.showAllChips() ? [] : this.selectedChips().slice(this.maxChips()));
        this.chipsInputPlaceholder = computed(() => this.displayedChips().length ? '' : this.buttonConfig.label);
