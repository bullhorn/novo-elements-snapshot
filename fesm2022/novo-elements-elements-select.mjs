...
import { EventEmitter, signal, input, booleanAttribute, computed, QueryList, Component, Optional, Self, Inject, Input, Output, ViewChild, ContentChildren, ViewChildren, HostListener, inject, Directive, NgModule } from '@angular/core';
