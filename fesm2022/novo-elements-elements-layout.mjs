...
import { partition, switchMap, race, of, delay, filter, map, merge, Subject, fromEvent } from 'rxjs';
...
class NovoCollapsibleNavComponent {
    constructor() {
        ...
        this.expandDelay = input(0, ...(ngDevMode ? [{ debugName: "expandDelay" }] : []));
    ...
    debounceHover(hoverSignal) {
        ...
        const waitedEnters = enters.pipe(switchMap(enter => race(of(enter).pipe(delay(this.expandDelay())), exits)), filter(result => result), map(() => this.element.nativeElement.matches(':hover')));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoCollapsibleNavComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { collapsed: [{ type: i0.Input, args: [{ isSignal: true, alias: "collapsed", required: false }] }, { type: i0.Output, args: ["collapsedChange"] }], expandedWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "expandedWidth", required: false }] }], collapsedWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "collapsedWidth", required: false }] }], expandDelay: [{ type: i0.Input, args: [{ isSignal: true, alias: "expandDelay", required: false }] }], overlayOnHover: [{ type: i0.Input, args: [{ isSignal: true, alias: "overlayOnHover", required: false }] }], hoveredChange: [{ type: i0.Output, args: ["hoveredChange"] }], onMouseEnter: [{
                type: HostListener,
                args: ['mouseenter']
            }], onMouseLeave: [{
                type: HostListener,
