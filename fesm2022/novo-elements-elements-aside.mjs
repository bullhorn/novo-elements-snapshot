...
import { signal, EventEmitter, Output, Component, Injectable, NgModule } from '@angular/core';
...
class AsideComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: AsideComponent, isStandalone: false, selector: "novo-aside", outputs: { animationStateChanged: "animationStateChanged" }, ngImport: i0, template: "<div *ngIf=\"!draggable\" class=\"aside-panel\" [@slideInOut]=\"animationState\" (@slideInOut.start)=\"onAnimationStart($event)\"\n  (@slideInOut.done)=\"onAnimationDone($event)\">\n  <ng-template [cdkPortalOutlet]=\"component\"></ng-template>\n</div>\n<div *ngIf=\"draggable\" class=\"aside-panel draggable\" [@slideInOut]=\"animationState\" (@slideInOut.start)=\"onAnimationStart($event)\"\n  (@slideInOut.done)=\"onAnimationDone($event)\" cdkDrag [cdkDragDisabled]=\"disableDrag()\" cdkDragBoundary=\".cdk-overlay-container\">\n  <div class=\"drag-handle\">\n    <ng-template [cdkPortalOutlet]=\"component\"></ng-template>\n  </div>\n</div>", styles: [":host .aside-panel{background-color:var(--background-bright, #ffffff);box-shadow:-3px 3px 15px 4px #3d464d33;height:100vh;width:50%;min-width:min-content;max-width:560px;position:absolute;top:0;right:0;padding:0;display:flex;justify-content:stretch;align-items:stretch}:host .aside-panel.draggable{position:absolute;max-width:none;height:auto;width:540px;left:calc(100vw - 560px);overflow:hidden;resize:both}:host .aside-panel.draggable .drag-handle{width:100%;height:calc(100% - 1rem)}\n"], dependencies: [{ kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i3.CdkDrag, selector: "[cdkDrag]", inputs: ["cdkDragData", "cdkDragLockAxis", "cdkDragRootElement", "cdkDragBoundary", "cdkDragStartDelay", "cdkDragFreeDragPosition", "cdkDragDisabled", "cdkDragConstrainPosition", "cdkDragPreviewClass", "cdkDragPreviewContainer", "cdkDragScale"], outputs: ["cdkDragStarted", "cdkDragReleased", "cdkDragEnded", "cdkDragEntered", "cdkDragExited", "cdkDragDropped", "cdkDragMoved"], exportAs: ["cdkDrag"] }, { kind: "directive", type: i4.CdkPortalOutlet, selector: "[cdkPortalOutlet]", inputs: ["cdkPortalOutlet"], outputs: ["attached"], exportAs: ["cdkPortalOutlet"] }], animations: [slideInOut] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: AsideComponent, decorators: [{
            type: Component,
            args: [{ selector: 'novo-aside', animations: [slideInOut], standalone: false, template: "<div *ngIf=\"!draggable\" class=\"aside-panel\" [@slideInOut]=\"animationState\" (@slideInOut.start)=\"onAnimationStart($event)\"\n  (@slideInOut.done)=\"onAnimationDone($event)\">\n  <ng-template [cdkPortalOutlet]=\"component\"></ng-template>\n</div>\n<div *ngIf=\"draggable\" class=\"aside-panel draggable\" [@slideInOut]=\"animationState\" (@slideInOut.start)=\"onAnimationStart($event)\"\n  (@slideInOut.done)=\"onAnimationDone($event)\" cdkDrag [cdkDragDisabled]=\"disableDrag()\" cdkDragBoundary=\".cdk-overlay-container\">\n  <div class=\"drag-handle\">\n    <ng-template [cdkPortalOutlet]=\"component\"></ng-template>\n  </div>\n</div>", styles: [":host .aside-panel{background-color:var(--background-bright, #ffffff);box-shadow:-3px 3px 15px 4px #3d464d33;height:100vh;width:50%;min-width:min-content;max-width:560px;position:absolute;top:0;right:0;padding:0;display:flex;justify-content:stretch;align-items:stretch}:host .aside-panel.draggable{position:absolute;max-width:none;height:auto;width:540px;left:calc(100vw - 560px);overflow:hidden;resize:both}:host .aside-panel.draggable .drag-handle{width:100%;height:calc(100% - 1rem)}\n"] }]
...
class NovoAsideModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.15", ngImport: i0, type: NovoAsideModule, declarations: [AsideComponent], imports: [CommonModule, DragDropModule, NovoCommonModule, OverlayModule, PortalModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.15", ngImport: i0, type: NovoAsideModule, providers: [NovoAsideService], imports: [CommonModule, DragDropModule, NovoCommonModule, OverlayModule, PortalModule] }); }
}
