...
export declare class NovoToolbarRow extends _NovoToolbarBase implements CanColor {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoToolbarRow, "novo-toolbar-row", never, { "color": "color"; "gap": "gap"; }, {}, never, never, false>;
}
export declare class NovoToolbar extends _NovoToolbarBase implements CanColor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoToolbar, "novo-toolbar", never, { "color": "color"; "gap": "gap"; }, {}, ["_toolbarRows"], ["*", "novo-toolbar-row"], false>;
}
export {};
