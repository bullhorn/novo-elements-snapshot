...
declare class NovoOverlayTemplateComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoOverlayTemplateComponent, "novo-overlay-template", never, { "position": { "alias": "position"; "required": false; }; "scrollStrategy": { "alias": "scrollStrategy"; "required": false; }; "width": { "alias": "width"; "required": false; }; "minWidth": { "alias": "minWidth"; "required": false; }; "height": { "alias": "height"; "required": false; }; "closeOnSelect": { "alias": "closeOnSelect"; "required": false; }; "hasBackdrop": { "alias": "hasBackdrop"; "required": false; }; "permitEscapeKeyExit": { "alias": "permitEscapeKeyExit"; "required": false; }; "trapKeyboardFocus": { "alias": "trapKeyboardFocus"; "required": false; }; "parent": { "alias": "parent"; "required": false; }; }, { "select": "select"; "opening": "opening"; "closing": "closing"; "backDropClicked": "backDropClicked"; }, never, ["*"], false, never>;
}

declare class NovoOverlayModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoOverlayModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<NovoOverlayModule, [typeof NovoOverlayTemplateComponent], [typeof i3.CommonModule, typeof i3$1.FormsModule, typeof i4.OverlayModule, typeof i5.ScrollingModule, typeof i6.A11yModule], [typeof NovoOverlayTemplateComponent, typeof i5.ScrollingModule]>;
