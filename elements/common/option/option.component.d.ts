...
export declare class NovoOptionBase implements FocusableOption, AfterViewChecked, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoOptionBase, never, never, { "keepOpen": "keepOpen"; "novoInert": "novoInert"; "value": "value"; "id": "id"; "disabled": "disabled"; "selected": "selected"; }, { "onSelectionChange": "onSelectionChange"; }, never, never, false>;
}
/**
...
export declare class NovoOption extends NovoOptionBase {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoOption, "novo-option", ["novoOption"], { "selected": "selected"; "keepOpen": "keepOpen"; "novoInert": "novoInert"; "value": "value"; "disabled": "disabled"; }, {}, never, ["*", "[novoSuffix]"], false>;
}
/**
