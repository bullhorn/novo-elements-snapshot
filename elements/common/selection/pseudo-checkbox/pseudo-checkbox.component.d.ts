 ...
 * @docs-private
 */
export declare type NovoPseudoCheckboxState = 'unchecked' | 'checked' | 'indeterminate';
export declare type NovoPseudoCheckboxShape = 'box' | 'circle' | 'line';
/**
...
export declare class NovoPseudoCheckbox {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoPseudoCheckbox, "novo-pseudo-checkbox", never, { "state": "state"; "shape": "shape"; "disabled": "disabled"; }, {}, never, never, false>;
}
