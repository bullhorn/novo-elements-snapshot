...
export declare class NovoItemElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoItemElement, "item", never, { "disabled": "disabled"; "keepOpen": "keepOpen"; }, { "action": "action"; }, never, ["*"], false, never>;
}
