...
export declare class NovoDropDownTrigger {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoDropDownTrigger, "[dropdownTrigger]", never, {}, {}, never, never, false>;
}
...
export declare class NovoItemElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoItemElement, "item", never, { "disabled": "disabled"; "keepOpen": "keepOpen"; }, { "action": "action"; }, never, ["*"], false>;
}
export declare class NovoDropdownListElement implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDropdownListElement, "list", never, {}, {}, ["items"], ["*"], false>;
}
export declare class NovoDropDownItemHeaderElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDropDownItemHeaderElement, "dropdown-item-header", never, {}, {}, never, ["*"], false>;
}
export {};
