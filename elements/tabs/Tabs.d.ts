...
export declare class NovoNavElement implements AfterContentChecked {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoNavElement, "novo-nav", never, { "theme": "theme"; "direction": "direction"; "outlet": "outlet"; "router": "router"; "condensed": "condensed"; "selectedIndex": "selectedIndex"; }, { "selectedIndexChange": "selectedIndexChange"; }, never, ["*"], false, never>;
}
export declare class NovoTabElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTabElement, "novo-tab", never, { "active": "active"; "color": "color"; "disabled": "disabled"; }, { "activeChange": "activeChange"; }, never, ["*"], false, never>;
}
export declare class NovoTabButtonElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTabButtonElement, "novo-tab-button", never, { "active": "active"; "disabled": "disabled"; }, {}, never, ["*"], false, never>;
}
export declare class NovoTabLinkElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTabLinkElement, "novo-tab-link", never, { "active": "active"; "disabled": "disabled"; "spy": "spy"; }, {}, never, ["*"], false, never>;
}
...
export declare class NovoNavContentElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoNavContentElement, "novo-nav-content", never, { "active": "active"; }, {}, never, ["*"], false, never>;
}
export declare class NovoNavHeaderElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoNavHeaderElement, "novo-nav-header", never, { "active": "active"; "forElement": "for"; }, {}, never, ["*"], false, never>;
}
