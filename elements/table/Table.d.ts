import { ChangeDetectorRef, DoCheck, ElementRef, EventEmitter, QueryList } from '@angular/core';
import { AbstractControl, FormBuilder, UntypedFormGroup } from '@angular/forms';
import { NovoLabelService, PagedArrayCollection } from 'novo-elements/services';
...
export declare class NovoTableElement implements DoCheck {
    ...
    get editing(): boolean;
    get formValue(): any;
    constructor(labels: NovoLabelService, formUtils: FormUtils, builder: FormBuilder, cdr: ChangeDetectorRef);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTableElement, "novo-table", never, { "config": { "alias": "config"; "required": false; }; "columns": { "alias": "columns"; "required": false; }; "theme": { "alias": "theme"; "required": false; }; "skipSortAndFilterClear": { "alias": "skipSortAndFilterClear"; "required": false; }; "mode": { "alias": "mode"; "required": false; }; "editable": { "alias": "editable"; "required": false; }; "rowIdentifier": { "alias": "rowIdentifier"; "required": false; }; "name": { "alias": "name"; "required": false; }; "rows": { "alias": "rows"; "required": false; }; "dataProvider": { "alias": "dataProvider"; "required": false; }; }, { "onRowClick": "onRowClick"; "onRowSelect": "onRowSelect"; "onTableChange": "onTableChange"; }, never, ["novo-table-header", "novo-table-actions", "[table-empty-message]", "[table-no-matching-records-message]", "[table-error-message]", "novo-table-footer"], false, never>;
}
