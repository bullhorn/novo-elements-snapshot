...
export declare class TableCell implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TableCell, "novo-table-cell", never, { "column": { "alias": "column"; "required": false; }; "row": { "alias": "row"; "required": false; }; "form": { "alias": "form"; "required": false; }; "hasEditor": { "alias": "hasEditor"; "required": false; }; }, {}, never, never, false, never>;
}
