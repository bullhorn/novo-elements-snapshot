...
export declare class NovoDropdownCell extends BaseRenderer implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDropdownCell, "novo-dropdown-cell", never, { "meta": { "alias": "meta"; "required": false; }; "value": { "alias": "value"; "required": false; }; }, {}, never, never, false, never>;
}
