...
export declare class Pagination implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Pagination, "novo-pagination", never, { "page": "page"; "totalItems": "totalItems"; "itemsPerPage": "itemsPerPage"; "rowOptions": "rowOptions"; "label": "label"; "disablePageSelection": "disablePageSelection"; }, { "pageChange": "pageChange"; "itemsPerPageChange": "itemsPerPageChange"; "onPageChange": "onPageChange"; }, never, never, false>;
}
export {};
