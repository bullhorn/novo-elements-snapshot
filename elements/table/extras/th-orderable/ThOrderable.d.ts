...
export declare class ThOrderable implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ThOrderable, "[novoThOrderable]", never, { "column": { "alias": "novoThOrderable"; "required": false; }; }, { "onOrderChange": "onOrderChange"; }, never, never, false, never>;
}
