...
export declare class RowDetails implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<RowDetails, "novo-row-details", never, { "data": { "alias": "data"; "required": false; }; "renderer": { "alias": "renderer"; "required": false; }; }, {}, never, never, false, never>;
}
