...
export declare class NovoStepHeader extends CdkStepHeader implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoStepHeader, "novo-step-header", never, { "theme": "theme"; "color": "color"; "icon": "icon"; "state": "state"; "label": "label"; "iconOverrides": "iconOverrides"; "index": "index"; "selected": "selected"; "active": "active"; "optional": "optional"; }, {}, never, never, false, never>;
}
