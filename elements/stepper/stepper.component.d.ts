...
export declare class NovoStep extends CdkStep {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoStep, "novo-step", never, { "theme": "theme"; "color": "color"; "icon": "icon"; }, {}, ["stepLabel"], ["*"], false>;
}
export declare class NovoStepper extends CdkStepper implements AfterContentInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoStepper, "[novoStepper]", never, {}, {}, ["steps", "_icons"], never, false>;
}
export declare class NovoHorizontalStepper extends NovoStepper {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoHorizontalStepper, "novo-horizontal-stepper", ["novoHorizontalStepper"], {}, {}, never, never, false>;
}
export declare class NovoVerticalStepper extends NovoStepper {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoVerticalStepper, "novo-vertical-stepper", ["novoVerticalStepper"], {}, {}, never, never, false>;
}
