...
export declare class PlacesListComponent extends BasePickerResults implements OnInit, OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PlacesListComponent, "google-places-list", never, { "userSettings": "userSettings"; }, { "termChange": "termChange"; "select": "select"; }, never, never, false, never>;
}
