...
declare class NovoSwitchElement implements ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoSwitchElement, "novo-switch", never, { "theme": { "alias": "theme"; "required": false; }; "icons": { "alias": "icons"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; }, { "onChange": "onChange"; }, never, ["*"], false, [{ directive: typeof i1.ActivateDirective; inputs: {}; outputs: { "novoActivate": "novoActivate"; }; }]>;
}
