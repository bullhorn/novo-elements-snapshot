...
export declare class NovoExpansionPanelHeader implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoExpansionPanelHeader, "novo-expansion-panel-header", never, { "expandedHeight": "expandedHeight"; "collapsedHeight": "collapsedHeight"; }, {}, never, ["novo-panel-title", "novo-panel-description", "*"], false, never>;
}
/**
