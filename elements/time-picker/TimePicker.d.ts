...
export declare class NovoTimePickerElement implements ControlValueAccessor, OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTimePickerElement, "novo-time-picker", never, { "military": "military"; "analog": "analog"; "inline": "inline"; "step": "step"; "hasButtons": "hasButtons"; "saveDisabled": "saveDisabled"; }, { "onSelect": "onSelect"; "onSave": "onSave"; "onCancel": "onCancel"; }, never, never, false>;
}
