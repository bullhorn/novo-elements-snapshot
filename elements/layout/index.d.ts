...
import { AfterContentInit, ChangeDetectorRef, ElementRef, NgZone, InjectionToken, AfterContentChecked, OnDestroy, EventEmitter, DoCheck, QueryList } from '@angular/core';
...
declare class NovoLayoutContent extends CdkScrollable implements AfterContentInit {
    ...
    _container: any;
    constructor(_changeDetectorRef: ChangeDetectorRef, _container: any, elementRef: ElementRef<HTMLElement>, scrollDispatcher: ScrollDispatcher, ngZone: NgZone);
