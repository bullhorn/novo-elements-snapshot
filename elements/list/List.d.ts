...
export declare class NovoListElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoListElement, "novo-list", never, { "theme": "theme"; "direction": "direction"; }, {}, never, ["*"], false, never>;
}
export declare class NovoItemAvatarElement {
    icon: string;
    color: string;
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoItemAvatarElement, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoItemAvatarElement, "item-avatar, novo-item-avatar", never, { "icon": "icon"; "color": "color"; }, {}, never, never, false, never>;
}
...
export declare class NovoItemContentElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoItemContentElement, "item-content, novo-item-content", never, { "direction": "direction"; }, {}, never, ["*"], false, never>;
}
