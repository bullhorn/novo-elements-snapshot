...
export declare class NovoDragBoxParent<T> implements AfterViewInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoDragBoxParent<any>, "[novoDragDrop]", never, { "items": "novoDragDrop"; }, { "novoDragDropFinish": "novoDragDropFinish"; }, never, never, false>;
}
export {};
