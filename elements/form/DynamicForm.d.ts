...
export declare class NovoFieldsetHeaderElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoFieldsetHeaderElement, "novo-fieldset-header", never, { "title": "title"; "icon": "icon"; }, {}, never, never, false>;
}
export declare class NovoFieldsetElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoFieldsetElement, "novo-fieldset", never, { "controls": "controls"; "form": "form"; "title": "title"; "icon": "icon"; "index": "index"; "autoFocus": "autoFocus"; "isEmbedded": "isEmbedded"; "isInlineEmbedded": "isInlineEmbedded"; "hidden": "hidden"; }, {}, never, never, false>;
}
export declare class NovoDynamicFormElement implements OnChanges, OnInit, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDynamicFormElement, "novo-dynamic-form", never, { "controls": "controls"; "fieldsets": "fieldsets"; "form": "form"; "layout": "layout"; "hideNonRequiredFields": "hideNonRequiredFields"; "autoFocusFirstField": "autoFocusFirstField"; }, {}, ["customTemplates"], ["form-title", "form-subtitle"], false>;
}
