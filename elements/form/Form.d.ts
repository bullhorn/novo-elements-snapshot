...
export declare class NovoFormElement implements AfterContentInit, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoFormElement, "novo-form", never, { "form": "form"; "layout": "layout"; "hideHeader": "hideHeader"; }, {}, ["customTemplates"], ["form-title", "form-subtitle", "*"], false, never>;
}
