...
export declare class NovoColorPickerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoColorPickerComponent, "novo-color-picker", never, { "width": "width"; "colors": "colors"; "color": "color"; }, { "onChange": "onChange"; "onChangeComplete": "onChangeComplete"; "onSwatchHover": "onSwatchHover"; }, never, never, false>;
}
