...
export declare class NovoColorSwatchComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoColorSwatchComponent, "novo-color-swatch", never, { "color": "color"; "style": "style"; "focusStyle": "focusStyle"; "focus": "focus"; }, { "onClick": "onClick"; "onHover": "onHover"; }, never, ["*"], false, never>;
}
