...
export declare class NovoHeaderSpacer {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoHeaderSpacer, "header-spacer", never, {}, {}, never, ["*"], false>;
}
export declare class NovoUtilsComponent {
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoUtilsComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoUtilsComponent, "utils", never, {}, {}, never, ["*"], false>;
}
export declare class NovoUtilActionComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoUtilActionComponent, "util-action, novo-action", never, { "icon": "icon"; "size": "size"; "inverse": "inverse"; "disabled": "disabled"; }, {}, never, ["*"], false>;
}
export declare class NovoHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoHeaderComponent, "novo-header,header[theme],header[accent]", never, { "condensed": "condensed"; "title": "title"; "subTitle": "subTitle"; "icon": "icon"; "size": "size"; "theme": "theme"; }, {}, never, ["[prefix]", "novo-icon, [novo-icon]", "h1, h2, h3, h4, h5, h6, small, novo-title, [novo-title], [novo-subtitle]", "section", "novo-action,[novo-action]", "utils", "[suffix]", "*"], false>;
}
