...
export declare class NovoCategoryDropdownElement extends OutsideClick implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoCategoryDropdownElement, "novo-category-dropdown", never, { "persistSelection": "persistSelection"; "closeOnSelect": "closeOnSelect"; "search": "search"; "footer": "footer"; "categories": "categories"; }, { "_select": "itemSelected"; "categorySelected": "categorySelected"; }, never, ["button"], false, never>;
}
