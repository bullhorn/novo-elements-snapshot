...
export declare class NovoRadioGroup extends NovoRadioGroupMixins implements NovoFieldControl<any>, ControlValueAccessor, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoRadioGroup, "novo-radio-group", never, { "id": "id"; "tabindex": "tabindex"; "errorStateMatcher": "errorStateMatcher"; "appearance": "appearance"; "value": "value"; "name": "name"; "disabled": "disabled"; "required": "required"; "placeholder": "placeholder"; }, { "change": "change"; "blur": "blur"; }, ["_radios"], ["*"], false>;
}
export {};
