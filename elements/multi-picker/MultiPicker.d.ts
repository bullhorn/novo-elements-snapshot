...
export declare class NovoMultiPickerElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoMultiPickerElement, "multi-picker", never, { "source": "source"; "placeholder": "placeholder"; "types": "types"; "value": "value"; }, { "changed": "changed"; "focus": "focus"; "blur": "blur"; }, never, never, false>;
}
export {};
