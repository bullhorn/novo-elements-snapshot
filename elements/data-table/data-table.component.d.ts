...
export declare class NovoDataTable<T> implements AfterContentInit, OnDestroy {
    ...
    novoDataTableContainerSignal: import("@angular/core").Signal<ElementRef<any>>;
    ...
    constructor(labels: NovoLabelService, ref: ChangeDetectorRef, state: DataTableState<T>, scrollStrategy: NovoDataTableVirtualScrollStrategy);
