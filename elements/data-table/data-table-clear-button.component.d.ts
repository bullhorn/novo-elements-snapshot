...
export declare class NovoDataTableClearButton<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDataTableClearButton<any>, "novo-data-table-clear-button", never, { "emitOnly": { "alias": "emitOnly"; "required": false; }; }, { "selectedClear": "selectedClear"; "sortClear": "sortClear"; "filterClear": "filterClear"; "queryClear": "queryClear"; "allClear": "allClear"; }, never, never, false, never>;
}
