...
export declare class NovoDataTableExpandDirective<T> implements OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoDataTableExpandDirective<any>, "[novoDataTableExpand]", never, { "row": "row"; "template": "novoDataTableExpand"; }, {}, never, never, false>;
}
