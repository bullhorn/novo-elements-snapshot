...
export declare class NovoDataTableCheckboxHeaderCell<T> extends CdkHeaderCell implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDataTableCheckboxHeaderCell<any>, "novo-data-table-checkbox-header-cell", never, { "maxSelected": "maxSelected"; }, {}, never, never, false, never>;
}
