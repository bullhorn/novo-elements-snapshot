...
export declare class NovoDataTableCellHeader<T> implements IDataTableSortFilter, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDataTableCellHeader<any>, "[novo-data-table-cell-config]", never, { "defaultSort": "defaultSort"; "allowMultipleFilters": "allowMultipleFilters"; "resized": "resized"; "filterTemplate": "filterTemplate"; "column": "novo-data-table-cell-config"; }, {}, never, never, false>;
}
