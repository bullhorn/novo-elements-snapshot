...
export declare class NovoDataTableCellFilterHeader {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDataTableCellFilterHeader, "novo-data-table-cell-filter-header", never, { "label": "label"; "filter": "filter"; }, { "clearFilter": "clearFilter"; }, never, never, false>;
}
