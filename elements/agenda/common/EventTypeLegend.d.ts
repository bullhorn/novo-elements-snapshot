...
export declare class NovoEventTypeLegendElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoEventTypeLegendElement, "novo-event-type-legend", never, { "events": "events"; "customTemplate": "customTemplate"; }, { "eventTypeClicked": "eventTypeClicked"; }, never, never, false>;
}
