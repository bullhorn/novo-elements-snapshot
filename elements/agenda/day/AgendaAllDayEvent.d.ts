...
export declare class NovoAgendaAllDayEventElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoAgendaAllDayEventElement, "novo-agenda-all-day-event", never, { "event": "event"; "customTemplate": "customTemplate"; }, { "eventClicked": "eventClicked"; }, never, never, false, never>;
}
