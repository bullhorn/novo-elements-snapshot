import { ElementRef, EventEmitter, Renderer2, SimpleChanges, OnChanges } from '@angular/core';
import { IMaskDirective, IMaskFactory } from 'angular-imask';
import { NovoLabelService } from 'novo-elements/services';
import { NovoInputFormat, DATE_FORMATS } from './base-format';
...
export declare class NovoDateTimeFormatDirective extends IMaskDirective<any> implements NovoInputFormat, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoDateTimeFormatDirective, "input[dateTimeFormat]", never, { "military": "military"; "dateTimeFormat": "dateTimeFormat"; }, {}, never>;
}
