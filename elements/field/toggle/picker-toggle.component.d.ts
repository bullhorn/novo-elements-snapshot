...
export declare class NovoPickerToggleElement<T = any> implements AfterContentInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoPickerToggleElement<any>, "novo-picker-toggle", ["novoPickerToggle"], { "picker": "for"; "icon": "icon"; "tabIndex": "tabIndex"; "ariaLabel": "aria-label"; "triggerOnFocus": "triggerOnFocus"; "overlayId": "overlayId"; "width": "width"; "disabled": "disabled"; }, {}, never, ["*"], false>;
}
