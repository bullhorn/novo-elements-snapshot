...
import { DatePickerSelectModes, RangeModel } from 'novo-elements/utils';
...
export declare class NovoDateRangeInputElement implements OnInit, OnChanges, ControlValueAccessor {
    ...
    _onStartInputKey(event: KeyboardEvent): void;
    _onStartInputChange(event: Event): void;
    _onEndInputKey(event: KeyboardEvent): void;
    _onEndInputChange(event: Event): void;
