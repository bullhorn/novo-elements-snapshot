...
export declare class NovoDatePickerElement implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoDatePickerElement, "novo-date-picker", never, { "minYear": "minYear"; "maxYear": "maxYear"; "start": "start"; "end": "end"; "inline": "inline"; "weekStart": "weekStart"; "preselected": "preselected"; "hideOverflowDays": "hideOverflowDays"; "hideFooter": "hideFooter"; "disabledDateMessage": "disabledDateMessage"; "numberOfMonths": "numberOfMonths"; "mode": "mode"; "range": "range"; "weekRangeSelect": "weekRangeSelect"; }, { "onSelect": "onSelect"; }, never, never, false>;
}
