...
export declare class NovoSimpleHeaderRowDef extends _NovoHeaderRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoSimpleHeaderRowDef, "[novoSimpleHeaderRowDef]", never, { "columns": "novoSimpleHeaderRowDef"; }, {}, never, never, false, never>;
}
export declare class NovoSimpleRowDef<T> extends _NovoCdkRowDef<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoSimpleRowDef<any>, "[novoSimpleRowDef]", never, { "columns": "novoSimpleRowDefColumns"; }, {}, never, never, false, never>;
}
