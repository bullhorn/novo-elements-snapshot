...
export declare class NovoSimpleHeaderRowDef extends _NovoHeaderRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoSimpleHeaderRowDef, "[novoSimpleHeaderRowDef]", never, { "columns": "novoSimpleHeaderRowDef"; }, {}, never>;
}
export declare class NovoSimpleRowDef<T> extends _NovoCdkRowDef<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoSimpleRowDef<any>, "[novoSimpleRowDef]", never, { "columns": "novoSimpleRowDefColumns"; }, {}, never>;
}
export declare class NovoSimpleHeaderRow extends _NovoHeaderRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoSimpleHeaderRow, "novo-simple-header-row", never, {}, {}, never, never>;
}
export declare class NovoSimpleRow extends _NovoRow {
    rowClass: string;
    role: string;
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoSimpleRow, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoSimpleRow, "novo-simple-row", never, {}, {}, never, never>;
}
