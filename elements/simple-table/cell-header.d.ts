...
export declare class NovoSimpleFilterFocus implements AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoSimpleFilterFocus, "[novoSimpleFilterFocus]", never, {}, {}, never, never, false>;
}
export declare class NovoSimpleCellHeader implements NovoSimpleSortFilter, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoSimpleCellHeader, "[novo-simple-cell-config]", never, { "defaultSort": "defaultSort"; "config": "novo-simple-cell-config"; }, {}, never, ["*"], false>;
}
