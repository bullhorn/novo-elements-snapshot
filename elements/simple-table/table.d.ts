...
export declare class NovoTable<T> extends CdkTable<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoTable<any>, "novo-simple-table", never, {}, {}, never, ["caption", "colgroup, col"], false>;
}
export declare class NovoActivityTableActions {
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoActivityTableActions, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoActivityTableActions, "novo-activity-table-actions", never, {}, {}, never, never, false>;
}
export declare class NovoActivityTableCustomHeader {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoActivityTableCustomHeader, "novo-activity-table-custom-header", never, {}, {}, never, never, false>;
}
export declare class NovoActivityTableCustomFilter {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoActivityTableCustomFilter, "novo-activity-table-custom-filter", never, {}, {}, never, never, false>;
}
export declare class NovoActivityTableEmptyMessage {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoActivityTableEmptyMessage, "novo-activity-table-empty-message", never, {}, {}, never, never, false>;
}
export declare class NovoActivityTableNoResultsMessage {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoActivityTableNoResultsMessage, "novo-activity-table-no-results-message", never, {}, {}, never, never, false>;
}
