...
export declare class NovoCheckListElement implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoCheckListElement, "novo-check-list", never, { "name": "name"; "options": "options"; "disabled": "disabled"; }, { "onSelect": "onSelect"; }, never, never, false>;
}
