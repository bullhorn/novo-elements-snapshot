...
import { InjectionToken, OnChanges, ElementRef, Signal, SimpleChanges } from '@angular/core';
import * as i2 from '@angular/common';

declare const FOCUS_MANAGED_CONTEXT: InjectionToken<boolean>;
declare class NovoButtonElement implements OnChanges {
    element: ElementRef;
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoButtonElement, "novo-button,button[theme]", never, { "color": { "alias": "color"; "required": false; }; "side": { "alias": "side"; "required": false; }; "size": { "alias": "size"; "required": false; }; "theme": { "alias": "theme"; "required": false; }; "loading": { "alias": "loading"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "secondIcon": { "alias": "secondIcon"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "inputTabindex": { "alias": "tabindex"; "required": false; }; }, {}, never, ["*"], false, never>;
}

declare class NovoButtonModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoButtonModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<NovoButtonModule, [typeof NovoButtonElement], [typeof i2.CommonModule], [typeof NovoButtonElement]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<NovoButtonModule>;
}

export { FOCUS_MANAGED_CONTEXT, NovoButtonElement, NovoButtonModule };
