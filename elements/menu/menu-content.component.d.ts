...
export declare class MenuContentComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MenuContentComponent, "menu-content", never, { "menuItems": "menuItems"; "item": "item"; "event": "event"; "menu": "menu"; "parentMenu": "parentMenu"; "menuClass": "menuClass"; "overlay": "overlay"; "isLeaf": "isLeaf"; }, { "openSubMenu": "openSubMenu"; "closeLeafMenu": "closeLeafMenu"; "closeAllMenus": "closeAllMenus"; }, never, never, false, never>;
}
