...
export declare class MenuDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MenuDirective, "[menu]", never, { "menuContext": "menuContext"; "menu": "menu"; "menuContent": "menuContent"; "waitWhenOpen": "waitWhenOpen"; "capture": "capture"; "anchor": "anchor"; "trigger": "trigger"; }, {}, never, never, false>;
}
