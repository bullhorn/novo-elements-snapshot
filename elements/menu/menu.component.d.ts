...
export declare class MenuComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MenuComponent, "novo-menu", never, { "menuClass": "menuClass"; "autoFocus": "autoFocus"; "disabled": "disabled"; }, { "close": "close"; "open": "open"; }, ["menuItems", "menuOptions"], never, false>;
}
