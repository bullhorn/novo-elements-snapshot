...
export declare class NovoValueElement implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoValueElement, "novo-value", never, { "data": "data"; "meta": "meta"; "theme": "theme"; "row": "row"; "label": "label"; "type": "type"; "icon": "icon"; }, {}, never, never, false, never>;
}
