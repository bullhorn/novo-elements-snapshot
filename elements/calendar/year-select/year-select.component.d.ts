...
export declare class NovoYearSelectElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoYearSelectElement, "novo-year-select", never, { "minYear": "minYear"; "maxYear": "maxYear"; "activeDate": "activeDate"; "selected": "selected"; }, { "select": "select"; }, never, never, false, never>;
}
