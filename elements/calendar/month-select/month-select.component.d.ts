...
export declare class NovoMonthSelectElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoMonthSelectElement, "novo-month-select", never, { "activeDate": "activeDate"; "selected": "selected"; }, { "select": "select"; }, never, never, false, never>;
}
