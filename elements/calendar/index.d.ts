...
import { OverlayDate, DatePickerSelectModes, NovoDateSelectionStrategy, NovoMonthSelectEvent, NovoYearSelectEvent, NovoDateSelectEvent, DateLike, Day as Day$2 } from 'novo-elements/utils';
...
declare class NovoMonthViewElement implements OnInit {
    ...
    _weekStartsOn: Day$1;
    get weekStartsOn(): Day$1;
    set weekStartsOn(value: Day$1);
    ...
    onSelect(event: Event, day: Day$2): void;
    onHover(event: Event, day: Day$2): void;
