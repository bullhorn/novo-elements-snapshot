...
export declare class NovoMonthViewElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoMonthViewElement, "novo-month-view", never, { "minDate": "minDate"; "maxDate": "maxDate"; "activeDate": "activeDate"; "selected": "selected"; "preview": "preview"; "overlays": "overlays"; "disabledDateMessage": "disabledDateMessage"; "isRange": "isRange"; "hideOverflowDays": "hideOverflowDays"; "weekStartsOn": "weekStartsOn"; }, { "select": "select"; "hover": "hover"; }, never, never, false>;
}
