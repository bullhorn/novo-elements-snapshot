...
export declare class BreadcrumbItemElement implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BreadcrumbItemElement, "novo-breadcrumb-item", never, { "showMenu": "showMenu"; "customMenuTemplate": "customMenuTemplate"; "menuList": "menuList"; "isSearch": "isSearch"; }, { "toggleEvent": "toggleEvent"; }, never, ["*"], false, never>;
}
