...
export declare class NovoChipInput implements NovoChipTextControl, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoChipInput, "input[novoChipInput]", ["novoChipInput", "novoChipInputFor"], { "addOnBlur": "novoChipInputAddOnBlur"; "separatorKeyCodes": "novoChipInputSeparatorKeyCodes"; "placeholder": "placeholder"; "id": "id"; "disabled": "disabled"; }, { "chipEnd": "novoChipInputTokenEnd"; }, never, never, false>;
}
