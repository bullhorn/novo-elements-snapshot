...
declare class NovoChipInput implements NovoChipTextControl, OnChanges, OnDestroy {
    ...
    constructor(_elementRef: ElementRef<HTMLInputElement>, _defaultOptions: NovoChipsDefaultOptions, _field: NovoFieldElement, _chipList: NovoChipList, ngControl: NgControl, _dir: Directionality);
    ngOnChanges(): void;
    ngOnDestroy(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NovoChipInput, [null, null, { optional: true; }, null, { optional: true; self: true; }, { optional: true; }]>;
