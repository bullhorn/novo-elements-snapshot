...
export declare class CardContentElement {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CardContentElement, "novo-card-content, [novo-card-content], [novoCardContent]", never, { "condensed": "condensed"; }, {}, never, ["*"], false, never>;
}
/**
 * Content of a card, needed as it's used as a selector in the API.
 */
...
export declare class CardElement implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CardElement, "novo-card", never, { "padding": "padding"; "config": "config"; "title": "title"; "message": "message"; "messageIcon": "messageIcon"; "icon": "icon"; "iconTooltip": "iconTooltip"; "refresh": "refresh"; "close": "close"; "move": "move"; "loading": "loading"; "inline": "inline"; "inset": "inset"; }, { "onClose": "onClose"; "onRefresh": "onRefresh"; }, never, ["novo-card-actions", "*", "footer,novo-card-footer,[novo-card-footer],[novoCardFooter]"], false, never>;
}
