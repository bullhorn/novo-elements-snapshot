...
export declare class CardContentElement {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<CardContentElement, "novo-card-content, [novo-card-content], [novoCardContent]", never, { "condensed": "condensed"; }, {}, never>;
}
/**
 * Content of a card, needed as it's used as a selector in the API.
 */
...
export declare class CardFooterElement {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<CardFooterElement, "novo-card-footer, [novo-card-footer], [novoCardFooter]", never, {}, {}, never>;
}
