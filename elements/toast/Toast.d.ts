...
export declare class NovoToastElement implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoToastElement, "novo-toast", never, { "appearance": "appearance"; "theme": "theme"; "icon": "icon"; "title": "title"; "action": "action"; "hasDialogue": "hasDialogue"; "link": "link"; "isCloseable": "isCloseable"; "message": "message"; }, { "closed": "closed"; }, never, ["*"], false>;
}
