...
export declare class ConditionInputOutlet implements QueryFilterOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ConditionInputOutlet, "[conditionInputOutlet]", never, {}, {}, never, never, false>;
}
/**
 * Provides a handle for the table to grab the view container's ng-container to insert data rows.
 * @docs-private
...
export declare class ConditionOperatorOutlet implements QueryFilterOutlet {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ConditionOperatorOutlet, "[conditionOperatorOutlet]", never, {}, {}, never, never, false>;
}
export declare class ConditionBuilderComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConditionBuilderComponent, "novo-condition-builder", never, { "label": "label"; "isFirst": "isFirst"; "andIndex": "andIndex"; "groupIndex": "groupIndex"; }, {}, never, ["*"], false>;
}
