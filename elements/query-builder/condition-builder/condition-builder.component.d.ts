...
export declare class ConditionBuilderComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConditionBuilderComponent, "novo-condition-builder", never, { "label": "label"; "isFirst": "isFirst"; "andIndex": "andIndex"; "groupIndex": "groupIndex"; }, {}, never, ["*"], false, never>;
}
