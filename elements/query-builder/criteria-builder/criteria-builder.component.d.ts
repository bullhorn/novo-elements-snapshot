...
export declare class CriteriaBuilderComponent implements OnInit, OnDestroy, AfterContentChecked, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CriteriaBuilderComponent, "novo-criteria-builder", never, { "config": "config"; "controlName": "controlName"; "allowedGroupings": "allowedGroupings"; "editTypeFn": "editTypeFn"; }, {}, ["_contentFieldDefs"], never, false>;
}
