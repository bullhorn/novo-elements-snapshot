...
interface NextFocusOpts {
    allowExit: boolean;
}
declare function focusWalker(startingPosition: HTMLElement, opts?: Partial<NextFocusOpts>): TreeWalker;
