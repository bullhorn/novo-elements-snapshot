...
import { AfterViewInit, ElementRef, ChangeDetectorRef, EventEmitter, OnChanges, ViewContainerRef, ComponentFactoryResolver, ComponentRef, SimpleChange } from '@angular/core';
...
declare class PopOverDirective implements OnChanges {
