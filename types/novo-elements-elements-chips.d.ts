...
import { InjectionToken, ElementRef, OnDestroy, EventEmitter, NgZone, ChangeDetectorRef, AfterViewInit, AfterContentInit, DoCheck, OnInit, QueryList, OnChanges, ViewContainerRef, PipeTransform } from '@angular/core';
...
declare class NovoChipInput implements NovoChipTextControl, OnChanges, OnDestroy {
    ...
    protected readonly _chipList: NovoChipList;
