...
export declare class NovoAceEditor implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoAceEditor, "novo-ace-editor", never, { "theme": "theme"; "options": "options"; "mode": "mode"; "name": "name"; }, { "blur": "blur"; "focus": "focus"; }, never, never, false, never>;
}
