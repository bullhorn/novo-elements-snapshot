...
export declare class NovoDragulaElement implements OnInit, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NovoDragulaElement, "[dragula]", never, { "bag": { "alias": "dragula"; "required": false; }; "dragulaModel": { "alias": "dragulaModel"; "required": false; }; }, {}, never, never, false, never>;
}
