...
export declare class NovoCodeEditor implements ControlValueAccessor, OnInit, OnDestroy, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NovoCodeEditor, "novo-code-editor", never, { "theme": "theme"; "lineNumbers": "lineNumbers"; "name": "name"; "mode": "mode"; }, { "blur": "blur"; "focus": "focus"; }, never, never, false, never>;
}
