...
import * as i1$1 from 'novo-elements/common';
import { NovoCommonModule } from 'novo-elements/common';
import * as i2$1 from 'novo-elements/components/icon';
...
//# sourceMappingURL=novo-elements-components-value.mjs.map
