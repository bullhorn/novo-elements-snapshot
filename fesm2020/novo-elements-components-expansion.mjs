...
NovoExpansionPanel.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.11", type: NovoExpansionPanel, selector: "novo-expansion-panel", inputs: { hideToggle: "hideToggle", padding: "padding" }, outputs: { opened: "opened", closed: "closed", expandedChange: "expandedChange" }, host: { properties: { "class.novo-expanded": "expanded", "class.novo-expansion-panel-spacing": "_hasSpacing()", "class.novo-expansion-panel-padding": "padding" }, classAttribute: "novo-expansion-panel" }, queries: [{ propertyName: "_lazyContent", first: true, predicate: NovoExpansionPanelContent, descendants: true }], exportAs: ["novoExpansionPanel"], usesInheritance: true, usesOnChanges: true, ngImport: i0, template: "<ng-content select=\"novo-expansion-panel-header\"></ng-content>\n<div class=\"novo-expansion-panel-content\"\n     role=\"region\"\n     [@bodyExpansion]=\"_getExpandedState()\"\n     (@bodyExpansion.done)=\"_bodyAnimation($event)\"\n     (@bodyExpansion.start)=\"_bodyAnimation($event)\"\n     [attr.aria-labelledby]=\"_headerId\"\n     [id]=\"id\"\n     #body>\n  <div class=\"novo-expansion-panel-body\">\n    <ng-content></ng-content>\n    <ng-template [cdkPortalOutlet]=\"_portal\"></ng-template>\n  </div>\n  <ng-content select=\"novo-action-row\"></ng-content>\n</div>\n", styles: ["[data-theme*=-dark] .novo-expansion-panel{background:var(--color-background-secondary)}.novo-expansion-panel{background:var(--color-background);color:var(--color-text)}.novo-action-row{border-top-color:var(--color-border)}.novo-expansion-panel:not(.novo-expanded) .novo-expansion-panel-header:not([aria-disabled=true]).cdk-keyboard-focused,.novo-expansion-panel:not(.novo-expanded) .novo-expansion-panel-header:not([aria-disabled=true]).cdk-program-focused,.novo-expansion-panel:not(.novo-expanded) .novo-expansion-panel-header:not([aria-disabled=true]):hover{background:rgba(0,0,0,.04)}.novo-expansion-panel-header-title{color:var(--color-text)}.novo-expansion-panel-header-description,.novo-expansion-indicator{border-color:var(--color-text)}.novo-expansion-panel-header[aria-disabled=true]{color:var(--color-text-disabled);pointer-events:none}.novo-expansion-panel-header[aria-disabled=true] .novo-expansion-panel-header-title,.novo-expansion-panel-header[aria-disabled=true] .novo-expansion-panel-header-description{color:inherit}.novo-expansion-panel.novo-expanded[theme=person]{border-top:3px solid var(--color-person)}.novo-expansion-panel.novo-expanded[theme=company]{border-top:3px solid var(--color-company)}.novo-expansion-panel.novo-expanded[theme=candidate]{border-top:3px solid var(--color-candidate)}.novo-expansion-panel.novo-expanded[theme=lead]{border-top:3px solid var(--color-lead)}.novo-expansion-panel.novo-expanded[theme=contact]{border-top:3px solid var(--color-contact)}.novo-expansion-panel.novo-expanded[theme=clientcontact]{border-top:3px solid var(--color-clientcontact)}.novo-expansion-panel.novo-expanded[theme=opportunity]{border-top:3px solid var(--color-opportunity)}.novo-expansion-panel.novo-expanded[theme=job]{border-top:3px solid var(--color-job)}.novo-expansion-panel.novo-expanded[theme=joborder]{border-top:3px solid var(--color-joborder)}.novo-expansion-panel.novo-expanded[theme=submission]{border-top:3px solid var(--color-submission)}.novo-expansion-panel.novo-expanded[theme=sendout]{border-top:3px solid var(--color-sendout)}.novo-expansion-panel.novo-expanded[theme=placement]{border-top:3px solid var(--color-placement)}.novo-expansion-panel.novo-expanded[theme=note]{border-top:3px solid var(--color-note)}.novo-expansion-panel.novo-expanded[theme=task]{border-top:3px solid var(--color-task)}.novo-expansion-panel.novo-expanded[theme=distribution-list]{border-top:3px solid var(--color-distribution-list)}.novo-expansion-panel.novo-expanded[theme=credential]{border-top:3px solid var(--color-credential)}.novo-expansion-panel.novo-expanded[theme=user]{border-top:3px solid var(--color-user)}.novo-expansion-panel.novo-expanded[theme=corporate-user]{border-top:3px solid var(--color-corporate-user)}.novo-expansion-panel.novo-expanded[theme=contract]{border-top:3px solid var(--color-contract)}.novo-expansion-panel.novo-expanded[theme=job-code]{border-top:3px solid var(--color-job-code)}.novo-expansion-panel.novo-expanded[theme=earn-code]{border-top:3px solid var(--color-earn-code)}.novo-expansion-panel.novo-expanded[theme=billable-charge]{border-top:3px solid var(--color-billable-charge)}.novo-expansion-panel.novo-expanded[theme=payable-charge]{border-top:3px solid var(--color-payable-charge)}.novo-expansion-panel.novo-expanded[theme=invoice-statement]{border-top:3px solid var(--color-invoice-statement)}.novo-expansion-panel.novo-expanded[theme=selection]{border-top:3px solid var(--color-selection)}.novo-expansion-panel.novo-expanded[theme=positive]{border-top:3px solid var(--color-positive)}.novo-expansion-panel.novo-expanded[theme=success]{border-top:3px solid var(--color-success)}.novo-expansion-panel.novo-expanded[theme=warning]{border-top:3px solid var(--color-warning)}.novo-expansion-panel.novo-expanded[theme=error]{border-top:3px solid var(--color-error)}.novo-expansion-panel.novo-expanded[theme=info]{border-top:3px solid var(--color-info)}.novo-expansion-panel.novo-expanded[theme=disabled]{border-top:3px solid var(--color-disabled)}.novo-expansion-panel.novo-expanded[theme=red]{border-top:3px solid var(--palette-red-50)}.novo-expansion-panel.novo-expanded[theme=pink]{border-top:3px solid var(--palette-pink-50)}.novo-expansion-panel.novo-expanded[theme=orange]{border-top:3px solid var(--palette-orange-50)}.novo-expansion-panel.novo-expanded[theme=yellow]{border-top:3px solid var(--palette-yellow-50)}.novo-expansion-panel.novo-expanded[theme=green]{border-top:3px solid var(--palette-green-50)}.novo-expansion-panel.novo-expanded[theme=teal]{border-top:3px solid var(--palette-teal-50)}.novo-expansion-panel.novo-expanded[theme=blue]{border-top:3px solid var(--palette-blue-50)}.novo-expansion-panel.novo-expanded[theme=aqua]{border-top:3px solid var(--palette-aqua-50)}.novo-expansion-panel.novo-expanded[theme=indigo]{border-top:3px solid var(--palette-indigo-50)}.novo-expansion-panel.novo-expanded[theme=violet]{border-top:3px solid var(--palette-violet-50)}.novo-expansion-panel.novo-expanded[theme=gray]{border-top:3px solid var(--palette-gray-50)}.novo-expansion-panel{box-shadow:0 3px 1px -2px #0003,0 2px 2px #00000024,0 1px 5px #0000001f;box-sizing:content-box;display:block;transition:margin 225ms ease-in-out;margin:0 16px}.novo-expansion-panel.novo-expanded:first-child{margin-top:0}.novo-expansion-panel.novo-expanded:last-child{margin-bottom:0}.novo-expansion-panel-content{overflow:hidden}.novo-expansion-panel-content.novo-expanded{overflow:visible}.novo-expansion-panel-padding .novo-expansion-panel-body{padding:0 24px 16px}.novo-expansion-panel-spacing{margin:16px 4px}.novo-accordion .novo-expansion-panel-spacing:first-child{margin-top:0}.novo-accordion .novo-expansion-panel-spacing:last-child{margin-bottom:0}.novo-action-row{border-top-style:solid;border-top-width:1px;display:flex;flex-direction:row;justify-content:flex-end;padding:16px 8px 16px 24px}.novo-action-row button.novo-button{margin-left:8px}[dir=rtl] .novo-action-row button.novo-button{margin-left:0;margin-right:8px}\n"], directives: [{ type: i3.CdkPortalOutlet, selector: "[cdkPortalOutlet]", inputs: ["cdkPortalOutlet"], outputs: ["attached"], exportAs: ["cdkPortalOutlet"] }], animations: [novoExpansionAnimations.bodyExpansion], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
