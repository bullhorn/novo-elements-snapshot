...
import { TemplateRef, InjectionToken, isDevMode, EventEmitter, Injectable } from '@angular/core';
...
const DYNAMIC_FORM_TEMPLATE = new InjectionToken('@bullhorn/ImportedFormTemplates');
