...
import { NovoOption, _countGroupLabelsBeforeOption } from 'novo-elements/common';
import { NovoFieldElement } from 'novo-elements/components/field';
import { NovoSelectElement } from 'novo-elements/components/select';
...
import * as i3 from "novo-elements/components/field";
import * as i4 from "novo-elements/components/checkbox";
import * as i5 from "novo-elements/components/icon";
import * as i6 from "novo-elements/components/loading";
import * as i7 from "novo-elements/components/button";
import * as i8 from "@angular/common";
import * as i9 from "novo-elements/components/tooltip";
import * as i10 from "@angular/forms";
import * as i11 from "novo-elements/common";
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: NovoSelectSearchComponent, decorators: [{
            ...
            args: [{ selector: 'novo-select-search', providers: [
                ...
                }] }, { type: i0.ChangeDetectorRef }, { type: i1.ViewportRuler }, { type: i11.NovoOption, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
                    args: [NovoOption]
                }] }, { type: i2.LiveAnnouncer }, { type: i3.NovoFieldElement, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
